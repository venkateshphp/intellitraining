...
<h3>Courses</h3>
  ...
  <a href="#" class="clear-button-new pull-right" id="clear_all">
Clear all</a>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $key;?>" class="course-filteration">
         <span class="glyphicon glyphicon-minus pull-right"></span>
          <!--Categories--><?php $term = get_taxonomy( $value);
    ...
    <div id="collapse<?php echo $key;?><?php /*?>collapseOne<?php */?>" class="panel-collapse collapse in" >
...
<!--sidebar-end-here-->
  ...
  <div class="col-md-8">
  <h4 class="pull-left"> <i class="fa fa-desktop"></i> Courses
 </h4>
 <div class="pull-right ga10"><a href="#"><i class="fa fa-list fa-lg" id="list"></i>
</a> <a href="#"><i class="fa fa-th fa-lg" id="grid"></i>
</a></div>
<div class="clearfix"></div>
<hr>
...
*/
 ...
 <div align="center" class="ga10"><a href="<?php echo get_term_link($single_taxonomy_cat[$key]->slug, $single_taxonomy_cat[$key]->taxonomy);?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/viewcourses-btrn.png" class="img-responsive" alt="#" border="0"></a></div>
  ...
  </div><!--filtered_product_part_grid-->
...
<div class="ga10 margin-bottom-20"><a href="<?php echo get_term_link($single_taxonomy_cat->slug, $single_taxonomy_cat->taxonomy);?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/viewcourses-btrn.png" class="img-responsive" alt="#" border="0"></a></div></div>
</div>
</div>
</div>
