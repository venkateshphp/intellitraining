...
<!--Footer Left and Right Section start-->
			<div class="overview">
			<h2> Footer Bootom Left and Right Section Content</h2>
			<form method="post" action="" >
			<?php 
			...
			<?php 
												          $Footer_left_content = get_option('Footer_left_content');
												          $Footer_right_content = get_option('Footer_right_content');
			
			?>
						<div class="single_whole_div">
						<label>Footer Left Content Text:</label> <input type="text" name="Footer_left_content" id="button_title" value="<?php echo $Footer_left_content;?>" />
						</div><!--single_whole_div-->
							<div class="single_whole_div">
						<label>Footer Right Content Text:</label> <input type="text" name="Footer_right_content" id="button_link" value="<?php echo $Footer_right_content;?>" />
							</div><!--single_whole_div-->
					<input id="btn" type="submit" value="Save" name="req_submit" />	
...
//								});
				...
				<?php	
								...
								*************************************/
								public static function theme_options_Footer_left_right_content_update(){
											$Footer_left_content = $_POST['Footer_left_content'];  
											$Footer_right_content = $_POST['Footer_right_content'];
											update_option('Footer_left_content',$Footer_left_content);
											update_option('Footer_right_content',$Footer_right_content);
			 ...
			 public static function resizeTheImage()
						{ 
							...
							add_image_size( 'gallery_image_pages', 675, 359, true ); //(cropped)
							}			
						}
								/************************************
