...
$whole_structure.='<div class="row'.$class.' new_key_value ='.$new_key_value.'">';
    ...
    $name = preg_replace('/[\[{\(].*[\]}\)]/U' , '', $single_taxonomy_cat->name);
		...
		$whole_structure.='<a href="#" class="text-center color-black">'.strip_shortcodes($string).'</a><div align="center" class="ga10"><a class="btn btn-md btn-black-line"  href="'.get_term_link($single_taxonomy_cat->slug, $single_taxonomy_cat->taxonomy).'"><i class="fa fa-check-square-o"></i>View More</a></div></div></div>';
...
$string = wp_trim_words( $single_taxonomy_cat->category_description, 10 ); 
$whole_structure_list.='<a href="#" class="text-center color-black">'.strip_shortcodes($string).'</a>
<div class="ga10 margin-bottom-20"><a class="btn btn-md btn-black-line"  href="'.get_term_link($single_taxonomy_cat->slug, $single_taxonomy_cat->taxonomy).'"><i class="fa fa-check-square-o"></i>View More</a></div></div></div></div></div><div class="clearfix"></div>';
		//For list End
