  ...
  <div class="container">
	...
	<?php 
		...
		<a href="<?php echo get_term_link($single_taxonomy_cat->slug, $single_taxonomy_cat->taxonomy);?>">
			<div class="over-Details for_min_height">
				<div class="product cat_image for_add_position">
				<?php $thumbnail_id = get_woocommerce_term_meta( $single_taxonomy_cat->term_id, 'thumbnail_id', true ); 
				// get the image URL
				$image = wp_get_attachment_url( $thumbnail_id ); 
				?><img class="for_width" src="<?php echo $image;?>"/>
				</div><!--product-->
				...
				echo strip_shortcodes( $string );
					...
					?></p>
						<div class="accred_div_card">
							...
							<span class="accred_title for_remove_mat"> View courses</span>
						</div>
				</div><!--pro-detail-->
			</div>
		</a><!--over-Details-->
